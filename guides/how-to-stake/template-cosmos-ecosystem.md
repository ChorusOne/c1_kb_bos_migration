---
description: Everything you need to know to stake your _____ with Chorus One
hidden: true
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/KGu77aAU8HQJ5FTwSgOi/guides/how-to-stake/template-cosmos-ecosystem
---

# TEMPLATE (Cosmos Ecosystem)

<mark style="color:red;">\<Picture if available></mark>

## Overview <a href="#h_01hc8bmw88thcadazdzytpfj3f" id="h_01hc8bmw88thcadazdzytpfj3f"></a>

<table data-header-hidden><thead><tr><th width="242"></th><th></th></tr></thead><tbody><tr><td><mark style="color:blue;"><strong>CATEGORY</strong></mark></td><td><mark style="color:blue;"><strong>DETAILS</strong></mark></td></tr><tr><td><strong>Chorus One Validator</strong></td><td><a href="https://www.mintscan.io/dymension/validators/dymvaloper1ema6flggqeakw3795cawttxfjspa48l4x0e2mh">dymvaloper1ema6flggqeakw3795cawttxfjspa48l4x0e2mh</a></td></tr><tr><td><strong>Recommended Wallets</strong></td><td><a href="https://www.keplr.app/">Kelpr</a> or <a href="https://www.leapwallet.io/">Leap</a> </td></tr><tr><td><strong>Block Explorer</strong></td><td><a href="https://lava-explorer.w3coins.io/Lava">h</a><a href="https://www.mintscan.io/dymension">https://www.mintscan.io/dymension</a></td></tr><tr><td><strong>Staking Rewards</strong></td><td><a href="https://www.stakingrewards.com/asset/dymension">https://www.stakingrewards.com/asset/dymension</a></td></tr><tr><td><strong>Unstaking Period</strong></td><td>21 Days</td></tr></tbody></table>

## About Dymension

**Dymension (DYM)** is a blockchain platform that empowers developers to create customizable app-specific chains called “RollApps.”

&#x20;These RollApps allow decentralized applications (dApps) to operate on their own independent chains with unique parameters and consensus mechanisms. By offering flexibility in the design of these app-chains, Dymension enhances scalability and performance for various use cases.&#x20;

* Dymension achieves this by utilizing a modular architecture that separates the consensus and execution layers, enabling greater adaptability and efficiency in building decentralized ecosystems.

Dymension is also part of the Cosmos ecosystem, promoting interoperability between different blockchains through its connection to the Cosmos Hub and other networks.&#x20;

* The DYM token token is used for governance, staking, and securing the network.

***

## How to Stake DYM <a href="#h_01hcdmyz7c17s7x9rzvke00phe" id="h_01hcdmyz7c17s7x9rzvke00phe"></a>
...
* **In this case, we will be adding Dymension (DYM), so please be sure to select that from the list or use the search bar to find it.**
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-05-20 at 5.21.13 PM (1).png" alt="" width="563"><figcaption><p>Be sure to search for DYM in the list in addition to Cosmos Hub.</p></figcaption></figure>
...
### 4. Stake your DYM <a href="#h_01hc8b1t0x326w2f4nzezyfjz6" id="h_01hc8b1t0x326w2f4nzezyfjz6"></a>

If you don't already have DYM in your wallet, you can fund it with some tokens. You may use an exchange to transfer the tokens to your address or get them from a trusted third party that already holds some.

If you want to stake from the browser extension wallet, you can either navigate to the [Keplr dashboard](https://wallet.keplr.app/) (shown below) or scroll down on the wallet screen and select DYM.&#x20;

{% hint style="info" %}
Alternatively, you can connect Keplr to the Mintscan explorer and stake to the Chorus One validator at this address: [dymvaloper1ema6flggqeakw3795cawttxfjspa48l4x0e2mh](https://www.mintscan.io/dymension/validators/dymvaloper1ema6flggqeakw3795cawttxfjspa48l4x0e2mh)
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.05.16 PM.png" alt=""><figcaption><p>Scroll down to find DYM or use the search bar.</p></figcaption></figure>

Once you are on the [Keplr dashboard](https://wallet.keplr.app/), to stake click on the 'Stake' tab on the left hand side of the dashboard.
...
Scroll or through the list or search for the chain you want, in this case **DYM**.
...
Once you've chosen the Chorus One validator, select how much DYM you wish to stake, then click the 'Stake' button at the bottom of the screen.
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.09.25 PM.png" alt=""><figcaption><p>Example of the DYM staking screen with Chorus One selected.</p></figcaption></figure>

{% hint style="info" %}
Please note that there is a 21 day unbonding process (also known as unstaking) for DYM.
...
### 6. Unstaking your DYM

If you wish to unstake your DYM, you can do so from the same interface in Keplr that you used to stake.&#x20;

* Either go to the [Keplr dashboard](https://wallet.keplr.app/) or manage your asset directly from the browser extension window.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.14.09 PM.png" alt=""><figcaption><p>Example of managing your DYM stake in the wallet extension.</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.15.18 PM.png" alt=""><figcaption><p>Example of the Keplr dashboard where you can see your active stake and selected validators. </p></figcaption></figure>

Simply click on the validator you wish to unstake from and you will be prompted with the following screen.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.16.52 PM.png" alt=""><figcaption><p>Example of the staking &#x26; unstaking screen.</p></figcaption></figure>

{% hint style="warning" %}
Please note that DYM undergoes a 21 day unbonding period when unstaking.&#x20;
{% endhint %}

To proceed, click on 'Unstake' and follow the prompts to select the amount of DYM you wish to unstake.

Then confirm and sign the transaction in your wallet.&#x20;

{% hint style="success" %}
And that's it! Your DYM will begin unbonding which you can track from your [Keplr dashboard](https://wallet.keplr.app/) under the Staking tab.
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-10-02 at 5.20.07 PM.png" alt=""><figcaption><p>Example above showing a DYM unstaking transaction in progress. </p></figcaption></figure>

{% hint style="success" %}
After the unbonding period is complete you will be able to transact with your unstaked DYM again!
{% endhint %}
...
If you are an institution looking to stake Dymension (DYM) with Chorus One, please reach out to us via our [staking request form](https://shorturl.at/znows).&#x20;

<details>

<summary><strong>About Chorus One</strong></summary>
