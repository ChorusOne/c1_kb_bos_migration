---
description: Everything you need to know to stake your STRD with Chorus One.
hidden: true
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/KGu77aAU8HQJ5FTwSgOi/guides/how-to-stake/how-to-stake-strd-stride-network
---
...
<table data-header-hidden><thead><tr><th width="224"></th><th></th></tr></thead><tbody><tr><td><mark style="color:blue;"><strong>CATEGORY</strong></mark></td><td><mark style="color:blue;"><strong>DETAILS</strong></mark></td></tr><tr><td><strong>Chorus One Validator</strong></td><td><a href="https://www.mintscan.io/stride/ics-validators/stridevaloper15urq2dtp9qce4fyc85m6upwm9xul3049u96tmy">stridevaloper15urq2dtp9qce4fyc85m6upwm9xul3049u96tmy</a></td></tr><tr><td><strong>Recommended Wallets</strong></td><td><a href="https://www.keplr.app/">Kelpr</a> or <a href="https://www.leapwallet.io/">Leap</a> </td></tr><tr><td><strong>Block Explorer</strong></td><td><a href="https://www.mintscan.io/stride">https://www.mintscan.io/stride</a></td></tr><tr><td><strong>Staking Rewards</strong></td><td><a href="https://www.stakingrewards.com/asset/stride/about">https://www.stakingrewards.com/asset/stride/about</a></td></tr><tr><td><strong>Unstaking Period</strong></td><td>21 Days</td></tr></tbody></table>
...
## How to Stake STRD <a href="#h_01hcdmyz7c17s7x9rzvke00phe" id="h_01hcdmyz7c17s7x9rzvke00phe"></a>
...
However, if you would like to use Leap wallet and stake directly to the [Chorus One validator](https://www.mintscan.io/stride/ics-validators/stridevaloper15urq2dtp9qce4fyc85m6upwm9xul3049u96tmy) via Mintscan, you can reference the quick guide below to start your Leap wallet.

If you already have a wallet installed, feel free to skip ahead to [How to Stake](how-to-stake-strd-stride-network.md#h_01hc8b1t0x326w2f4nzezyfjz6).
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-05-20 at 5.21.13 PM (1).png" alt="" width="563"><figcaption><p>Be sure to search for STRD in the list in addition to Cosmos Hub.</p></figcaption></figure>
...
### 4. Stake your STRD <a href="#h_01hc8b1t0x326w2f4nzezyfjz6" id="h_01hc8b1t0x326w2f4nzezyfjz6"></a>
...
If you want to stake from the browser extension wallet, you can either navigate to the [Keplr dashboard](https://wallet.keplr.app/) (shown below) or scroll down on the wallet screen and select STRD.&#x20;

{% hint style="info" %}
Alternatively, you can connect Keplr to the Mintscan explorer and stake to the Chorus One validator at this address: [stridevaloper15urq2dtp9qce4fyc85m6upwm9xul3049u96tmy](https://www.mintscan.io/stride/ics-validators/stridevaloper15urq2dtp9qce4fyc85m6upwm9xul3049u96tmy)
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.53.25 PM.png" alt=""><figcaption><p>Scroll down to find STRD or use the search bar.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.54.35 PM.png" alt=""><figcaption><p>Example of the STRD dashboard in Keplr.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.56.07 PM.png" alt=""><figcaption><p>Example of the STRD staking screen with Chorus One selected.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.57.05 PM.png" alt=""><figcaption><p>Example of managing your stake in the wallet extension.</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.57.40 PM.png" alt=""><figcaption><p>Example of the Keplr dashboard where you can see your active stake and selected validators. </p></figcaption></figure>

Simply click on the validator you wish to unstake from and you will be prompted with the following screen.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 5.58.41 PM.png" alt=""><figcaption><p>Example of the STRD staking &#x26; unstaking screen.</p></figcaption></figure>
...
{% hint style="success" %}
And that's it! Your STRD tokens will begin unbonding which you can track from your [Keplr dashboard](https://wallet.keplr.app/) under the Staking tab.
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.00.16 PM.png" alt=""><figcaption><p>Example above showing a STRD unstaking transaction in progress. </p></figcaption></figure>
...
If you are an institutional investor looking to stake Stride (STRD) with Chorus One, please reach out to us via our [staking request form](https://shorturl.at/znows).&#x20;
