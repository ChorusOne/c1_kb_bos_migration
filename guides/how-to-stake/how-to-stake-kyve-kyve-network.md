---
description: Everything you need to know to stake your KYVE with Chorus One.
hidden: true
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/KGu77aAU8HQJ5FTwSgOi/guides/how-to-stake/how-to-stake-kyve-kyve-network
---

# How to stake KYVE (Kyve Network)

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 4.59.04 PM.png" alt=""><figcaption><p>Source: <a href="https://www.kyve.network/">https://www.kyve.network/</a></p></figcaption></figure>

## Overview <a href="#h_01hc8bmw88thcadazdzytpfj3f" id="h_01hc8bmw88thcadazdzytpfj3f"></a>

<table data-header-hidden><thead><tr><th width="242"></th><th></th></tr></thead><tbody><tr><td><mark style="color:blue;"><strong>CATEGORY</strong></mark></td><td><mark style="color:blue;"><strong>DETAILS</strong></mark></td></tr><tr><td><strong>Chorus One Validator</strong></td><td><a href="https://www.mintscan.io/kyve/validators/kyvevaloper16pj5gljqnqs0ajxakccfjhu05yczp987rv492n">kyvevaloper16pj5gljqnqs0ajxakccfjhu05yczp987rv492n</a> or use:<br><a href="https://wallet.keplr.app/chains/kyve?modal=validator&#x26;chain=kyve-1&#x26;validator_address=kyvevaloper16pj5gljqnqs0ajxakccfjhu05yczp987rv492n">Stake Kyve with Chorus One</a></td></tr><tr><td><strong>Recommended Wallets</strong></td><td><a href="https://www.keplr.app/">Kelpr</a> or <a href="https://www.leapwallet.io/">Leap</a> </td></tr><tr><td><strong>Block Explorer</strong></td><td><a href="https://www.mintscan.io/kyve">https://www.mintscan.io/kyve</a></td></tr><tr><td><strong>Staking Rewards</strong></td><td><a href="https://www.stakingrewards.com/asset/kyve-network">https://www.stakingrewards.com/asset/kyve-network</a></td></tr><tr><td><strong>Unstaking Period</strong></td><td>21 Days</td></tr></tbody></table>
...
## How to Stake KYVE <a href="#h_01hcdmyz7c17s7x9rzvke00phe" id="h_01hcdmyz7c17s7x9rzvke00phe"></a>
...
If you already have a wallet installed, feel free to skip ahead to: [Stake your KYVE](how-to-stake-kyve-kyve-network.md#h_01hc8b1t0x326w2f4nzezyfjz6)
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-05-20 at 5.21.13 PM (1).png" alt="" width="563"><figcaption><p>Be sure to search for KYVE in the list in addition to Cosmos Hub.</p></figcaption></figure>
...
### 4. Stake your KYVE <a href="#h_01hc8b1t0x326w2f4nzezyfjz6" id="h_01hc8b1t0x326w2f4nzezyfjz6"></a>
...
If you want to stake from the browser extension wallet, you can either navigate to the [Keplr dashboard](https://wallet.keplr.app/) (shown below) or scroll down on the wallet screen and select KYVE.&#x20;

{% hint style="info" %}
Alternatively, you can connect Keplr to the Mintscan explorer and stake to the Chorus One validator at this address: [kyvevaloper16pj5gljqnqs0ajxakccfjhu05yczp987rv492n](https://www.mintscan.io/kyve/validators/kyvevaloper16pj5gljqnqs0ajxakccfjhu05yczp987rv492n)

Or you can navigate to thenChorus One staking page and click on 'Stake Now'

* [https://chorus.one/crypto-staking-networks/kyve](https://chorus.one/crypto-staking-networks/kyve)
{% endhint %}
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.08.28 PM.png" alt=""><figcaption><p>Scroll down to find KYVE or use the search bar.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.12.14 PM.png" alt=""><figcaption><p>Example of the KYVE staking dashboard in Keplr.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.14.24 PM.png" alt=""><figcaption><p>Example of the KYVE staking screen with Chorus One selected.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.15.50 PM.png" alt=""><figcaption><p>Example of managing your KYVE stake in the wallet extension.</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.16.48 PM.png" alt=""><figcaption><p>Example of the Keplr dashboard where you can see your active stake and selected validators. </p></figcaption></figure>

Simply click on the validator you wish to unstake from and you will be prompted with the following screen.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.17.40 PM.png" alt=""><figcaption><p>Example of the staking &#x26; unstaking screen.</p></figcaption></figure>
...
{% hint style="success" %}
And that's it! Your KYVE will begin unbonding which you can track from your [Keplr dashboard](https://wallet.keplr.app/) under the Staking tab.
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-19 at 5.20.12 PM.png" alt=""><figcaption><p>Example above showing a KYVE unstaking transaction in progress. </p></figcaption></figure>
...
If you are an institutional investor looking to stake Kyve Network (KYVE) with Chorus One, please reach out to us via our [staking request form](https://shorturl.at/znows).&#x20;
