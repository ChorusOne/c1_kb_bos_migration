---
description: Everything you need to know to stake your BLD with Chorus One.
hidden: true
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/KGu77aAU8HQJ5FTwSgOi/guides/how-to-stake/how-to-stake-bld-agoric-network
---
...
<table data-header-hidden><thead><tr><th width="224"></th><th></th></tr></thead><tbody><tr><td><mark style="color:blue;"><strong>CATEGORY</strong></mark></td><td><mark style="color:blue;"><strong>DETAILS</strong></mark></td></tr><tr><td><strong>Chorus One Validator</strong></td><td><a href="https://agoric.explorers.guru/validator/agoricvaloper15urq2dtp9qce4fyc85m6upwm9xul3049770a06">agoricvaloper15urq2dtp9qce4fyc85m6upwm9xul3049770a06</a> or use: <a href="https://chorus.one/crypto-staking-networks/agoric">https://chorus.one/crypto-staking-networks/agoric</a></td></tr><tr><td><strong>Recommended Wallets</strong></td><td><a href="https://www.keplr.app/">Kelpr</a> or <a href="https://www.leapwallet.io/">Leap</a> </td></tr><tr><td><strong>Block Explorer</strong></td><td><a href="https://agoric.explorers.guru/">https://agoric.explorers.guru/</a></td></tr><tr><td><strong>Staking Rewards</strong></td><td><a href="https://www.stakingrewards.com/asset/agoric">https://www.stakingrewards.com/asset/agoric</a></td></tr><tr><td><strong>Unstaking Period</strong></td><td>21 Days</td></tr></tbody></table>
...
## How to Stake BLD <a href="#h_01hcdmyz7c17s7x9rzvke00phe" id="h_01hcdmyz7c17s7x9rzvke00phe"></a>
...
However, if you would like to use Leap wallet and stake directly to the [Chorus One validator](https://agoric.explorers.guru/validator/agoricvaloper15urq2dtp9qce4fyc85m6upwm9xul3049770a06) via Mintscan, you can reference the quick guide below to start your Leap wallet.

If you already have a wallet installed, feel free to skip ahead to [How to Stake](how-to-stake-bld-agoric-network.md#h_01hc8b1t0x326w2f4nzezyfjz6).
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-05-20 at 5.21.13 PM (1).png" alt="" width="563"><figcaption><p>Be sure to search for Agoric in the list in addition to Cosmos Hub.</p></figcaption></figure>
...
Or you can go to [https://wallet.keplr.app/?tab=staking](https://wallet.keplr.app/?tab=staking) to view all assets you hold that can be staked and overview your staking positions.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-14 at 7.22.14 PM.png" alt=""><figcaption><p>Example of the Keplr staking dashboard.</p></figcaption></figure>

***

### 4. Stake your BLD <a href="#h_01hc8b1t0x326w2f4nzezyfjz6" id="h_01hc8b1t0x326w2f4nzezyfjz6"></a>
...
If you want to stake from the browser extension wallet, you can either navigate to the [Keplr dashboard](https://wallet.keplr.app/) (shown below) or scroll down on the wallet screen and select BLD.&#x20;

{% hint style="info" %}
Alternatively, you can connect Keplr to the Mintscan explorer and stake to the Chorus One validator at this address: [agoricvaloper15urq2dtp9qce4fyc85m6upwm9xul3049770a06](https://agoric.explorers.guru/validator/agoricvaloper15urq2dtp9qce4fyc85m6upwm9xul3049770a06)&#x20;
{% endhint %}

Next, you will be prompted to stake.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.08.29 PM.png" alt=""><figcaption><p>How to access the dashboard from the wallet browser extension</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.09.24 PM.png" alt=""><figcaption><p>Scroll down to find BLD or use the search bar.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.10.44 PM.png" alt=""><figcaption></figcaption></figure>

Alternatively, you can access your entire Keplr staking dashboard [here](https://wallet.keplr.app/?tab=staking).&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.11.19 PM.png" alt=""><figcaption><p>Example of the BLD dashboard in Keplr.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.12.56 PM.png" alt=""><figcaption><p>Example of the BLD staking screen with Chorus One selected.</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.13.55 PM.png" alt=""><figcaption><p>Example of managing your stake in the wallet extension.</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.14.51 PM.png" alt=""><figcaption><p>Example of the Keplr dashboard where you can see your active stake and selected validators. </p></figcaption></figure>

Simply click on the validator you wish to unstake from and you will be prompted with the following screen.&#x20;

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.15.36 PM.png" alt=""><figcaption><p>Example of the staking &#x26; unstaking screen.</p></figcaption></figure>

{% hint style="warning" %}
Please note that BLD undergoes a 21 day unbonding period when unstaking.&#x20;
{% endhint %}

<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 2.51.45 PM.png" alt=""><figcaption><p>Example of the 21 day unstaking warning before finalizing the transaction.</p></figcaption></figure>
...
{% hint style="success" %}
And that's it! Your BLD tokens will begin unbonding which you can track from your [Keplr dashboard](https://wallet.keplr.app/) under the Staking tab.
...
<figure><img src="../../.gitbook/assets/Screenshot 2024-11-15 at 6.17.16 PM.png" alt=""><figcaption><p>Example above showing an unstaking transaction in progress. </p></figcaption></figure>
...
If you are an institutional investor looking to stake Agoric (BLD) with Chorus One, please reach out to us via our [staking request form](https://shorturl.at/znows).&#x20;
